...
- (void)copy:(id)sender {
  if ([[[[self windowControllers][0] window] firstResponder]
    ...
    NSData* copyData = [NSArchiver archivedDataWithRootObject:copyDictionary];
...
- (void)paste:sender {
  ...
  NSManagedObjectContext *moc = [self managedObjectContext];
  NSArray *insertedReportsArray = [NSUnarchiver unarchiveObjectWithData:data];
...
- (void)reportBug:(id)sender {
  ...
  NSString *supportString = @"https://circlesapp.zendesk.com";
...
- (NSPrintOperation *)printOperationWithSettings:(NSDictionary *)printSettings error:(NSError **)outError
{
    ...
    [firstParaStyle setAlignment:NSCenterTextAlignment];
    ...
    [[printView textStorage] appendAttributedString:[[NSAttributedString alloc] initWithString:parSeparatorString]];
      [[printView textStorage] appendAttributedString:[[NSAttributedString alloc] initWithString:parSeparatorString]];
            ...
            [nameParaStyle setAlignment:NSCenterTextAlignment];
            ...
            [pointsParaStyle setAlignment:NSCenterTextAlignment];
